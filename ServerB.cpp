...
#define MYPORT "31126" // the port client will be connecting to
...
int main(int argc, char *argv[]) {
    ...
    while(1){
        ...
        if(friends == -2){
            ...
            if(friends == -3){
                printf("The server B is searching possible friends for User<%d>...\nHere are the results: User<NONE>\n", user_id);
            }else{
